...
public class JuegoSudoku extends JFrame {
    ...
    public JuegoSudoku() {
        ...
        panelBotones.add(botonRegresar); // Agregar el botón al panel
    ...
    private void guardarEnCuadrante(Casilla casilla) {
        ...
        if (cuadrante == cuadrante1 || cuadrante == cuadrante3 || cuadrante == cuadrante5 || cuadrante == cuadrante7
                || cuadrante == cuadrante9) {
            casilla.getButton().setBackground(Color.white);
        }
    ...
    private void llenarTablero() {
        MouseAdapter mouseAdapter = new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                for (int r = 0; r < FILAS; r++) {
                    for (int c = 0; c < COLUMNAS; c++) {
                        if (tablero[r][c].getButton() == e.getSource()) {
                ...
                if (casillapresionada.puedeCambiar()) {
                    ...
                    JOptionPane.showMessageDialog(null, "No se puede cambiar el valor de las casillas prederminadas.",
        ...
        for (int r = 0; r < FILAS; r++) {
            for (int c = 0; c < COLUMNAS; c++) {
                ...
                tablero[r][c].getButton().addMouseListener(mouseAdapter);
                panelTablero.add(tablero[r][c].getButton());
    ...
    private void ControlarClick(Casilla casillapresionada) {
        ...
        do {
            ...
            try {
                n = Integer.parseInt(JOptionPane.showInputDialog(
                        "Ingrese el numero que desea anexar en esta casilla [Ingrese 0 para vaciar los contenidos]"));
        ...
        if (esNumeroValido(n, casillapresionada.getColumna(), casillapresionada.getFila())) {
            ...
            JOptionPane.showMessageDialog(this, "ERROR. El numero esta repetido.", "ERROR",
    ...
    private boolean esNumeroValido(int num, int col, int row) {
        return (esValidoCuadrante(num, row, col) && esValidoFila(num, row) && esValidoColumna(num, col));
    ...
    private void generarNumerosAleatorios() {
            ...
            for (int i = 0; i < cantidadNumerosEnColumna; i++) {
                do {
                    ...
                    esValido = (esValidoCuadrante(numeroGenerado, filaSeleccionada, j)
                            ...
                            && esValidoColumna(numeroGenerado, j)) && tablero[filaSeleccionada][j]
                                    .getnumeroActual() == -1;
        ...
        System.out.println(
                "[generarNumerosAleatorios] Numeros que quedaron pendientes de colocar: " + numerosPendientes);
    }
...
class Casilla {
    ...
    public void setnumeroActual(int numeroActual) {
        ...
        if (numeroActual == 0) {
            ...
            button.setText(String.valueOf(numeroActual));
        }
    }
